...
<body>
    ...
    {{-- Orders --}}
    <div class="p-5">
        <div class="flex flex-row p-5 leading-normal border shadow-md hover:bg-gray-100 dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-700">
            <div class="w-1/5">
            ...
            <div class="w-4/5">
                ...
                <div class="flex flex-col items-center bg-white rounded-lg border shadow-md md:flex-row md:max-w-full hover:bg-gray-100 dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-700">
                    ...
                    <div class="flex flex-col justify-between p-4 leading-normal w-4/6">
                        <h5 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white"> Cheeseburger </h5>
                        <p class="mb-3 font-normal text-gray-700 dark:text-gray-400"> Quantity: 1 </p>
                    </div>
          ...
          <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
              ...
              <div class="p-6 pt-3 text-center">
                  ...
                  <div class="flex justify-center pb-5">
                    <svg role="status" class="mr-2 w-16 h-16 text-gray-200 animate-spin dark:text-gray-600 fill-green-500" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <h3 class="mb-5 text-lg font-normal text-gray-500 dark:text-gray-400">Payment is being processed.</h3>
      ...
      <div class="relative px-4 w-full max-w-md h-full md:h-auto">
          ...
          <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
              ...
              <div class="p-6 pt-3 text-center">
                  ...
                  <h3 class="mb-5 text-2xl font-semibold text-gray-600 dark:text-gray-400">Payment successful!</h3>
                  {{-- <button data-modal-toggle="popup-modal" type="button" class="closePaymentModal text-white bg-red-600 hover:bg-red-800 focus:ring-4 focus:ring-red-300 font-medium rounded-lg text-sm inline-flex items-center px-5 py-2.5 text-center mr-2">
                      Yes, I'm sure
                  </button>
                  <button data-modal-toggle="popup-modal" type="button" class="closePaymentModal text-gray-500 bg-white hover:bg-gray-100 focus:ring-4 focus:ring-gray-300 rounded-lg border border-gray-200 text-sm font-medium px-5 py-2.5 hover:text-gray-900 focus:z-10 dark:bg-gray-700 dark:text-gray-300 dark:border-gray-500 dark:hover:text-white dark:hover:bg-gray-600">No, cancel</button> --}}
