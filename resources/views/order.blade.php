...
@section('content')
            ...
            <div class="w-4/5">
                <div class="flex flex-col justify-between">
                    <div class="flex flex-col items-center bg-white rounded-lg border shadow-md md:flex-row md:max-w-full hover:bg-gray-100">
                        ...
                        <div class="flex justify-center leading-normal w-1/6">
                            <button class="hidden openRemoveModal text-red-700 font-semibold bg-inherit border-red-500 rounded hover:text-white hover:bg-red-500 hover:border-transparent py-1 px-3 border-2">
                            <span> Remove </span>
                            </button>
                        </div>
                    </div>
    ...
    {{-- Remove item modal (old) --}}
    <div class="invisible fixed z-10 inset-0 overflow-y-auto" aria-labelledby="modal-title" role="dialog" aria-modal="true" id="remove-modal_old">
