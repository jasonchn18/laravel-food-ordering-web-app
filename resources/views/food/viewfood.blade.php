...
<div class="flex flex-col items-center">
    <div class="flex flex-col items-center w-8/12">
        <div class="self-end py-2">
            <button onclick="location.href='/addfood'" style="font-size:20px" class="flex py-2 px-4 border border-transparent shadow-sm text-lg 
            font-medium rounded-md text-white bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">Add <i class="material-icons ">add</i></button>
        </div>
